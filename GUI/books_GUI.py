...
class control_books():
    ...
    def show_latest_books(self,content_frame, latest_books): 
        ...
        if latest_books:
            for index, book in enumerate(latest_books):
                ...
                card =self.create_book_card(books_container, book) 
    ...
    def create_book_card(self,parent_frame, book_data):
        CARD_WIDTH = 200  
        CARD_HEIGHT = 200
        ...
        title_label.bind("<Button-1>",lambda e:self.show_book_details_view (parent_frame, book_data) )
